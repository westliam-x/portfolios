...
function Intro(){
    ...
    <div className=' py-6 mb-12 '>
        ...
        <h2 className=' text-2xl py-2 text-blue-500 font-medium md:text-6xl'>William Emelifonwu</h2>
        ...
        <div className=' text-5xl justify-center gap-16 text-gray-600 flex'>
            ...
            <a className=' hover:text-blue-500'  href="https://www.linkedin.com/in/william-emelifonwu-27a7b51bb"><AiFillLinkedin size={30}/></a>
            <a className=' hover:text-blue-500'  href="https://github.com/westliam-x"> <AiFillGithub size={30}/></a>
            <a className=' hover:text-blue-500'  href="mailto:emelifonwuw@gmail.com"> <AiFillMail size={30}/></a>
        </div>
    </div>
