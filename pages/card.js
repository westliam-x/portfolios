    ...
    <div className="lg:flex gap-16">
      ...
      >
        <div>
          ...
          <h3 className=" text-lg font-medium pt-8 pb-2">
            Exquisite UI Designs
          </h3>
          <p className="py-2">
            Creating beautiful UI designs to satisfy your needs and the needs of
            your clients
          </p>
      ...
      >
        <div>
          ...
          <p className="py-2">
            You have an idea for your next web project? I can make it a reality{" "}
          </p>
      ...
      >
        <div>
          ...
          <p className="py-2">
            I can help with your next big project, collaborating and helping you
